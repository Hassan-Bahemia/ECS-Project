...
public class RotateSystem : SystemBase
{
    protected override void OnUpdate()
    {
        Entities.ForEach((
            ...
            ref Rotation _rotation, in MovementParametersComponentData _parametersComponentData,
            in PhysicsMass _physicsMass) =>
        {
            ...
            var currentAngularSpeed =
                PhysicsComponentExtensions.GetAngularVelocityWorldSpace(in _velocity, in _physicsMass, in _rotation);
